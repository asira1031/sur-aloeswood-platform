...
export const treasuryAccounts = {
  SUR_OPERATING: {
    ...
    accountProvider: "Configured privately by admin",
    accountName: "SUR operating account",
    accountNumber: "Not stored in client source",
    percent: 60,
  },
  TDI_REVENUE: {
    ...
    accountProvider: "Configured privately by admin",
    accountName: "Technology operations account",
    accountNumber: "Not stored in client source",
    percent: 10,
  },
  ...
  JSTUDIOS_EVENTS: {
    ...
    accountProvider: "Configured privately by admin",
    accountName: "Creative services account",
    accountNumber: "Not stored in client source",
    percent: 10,
  },
};
