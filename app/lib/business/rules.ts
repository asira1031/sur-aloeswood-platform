...
export const MONTHLY_TREE_CARE_FEE = 200;
export const ONE_TIME_TREE_CARE_FEE = 5000;
export const TREE_ESTIMATED_GROSS_MINIMUM = 200000;
export const TREE_ESTIMATED_GROSS_MAXIMUM = 300000;
export const WITHDRAWAL_MINIMUM = 100;
export const WITHDRAWAL_MAXIMUM = 50000;
...
export const RECOVERY_FUND_WITHDRAWAL_MINIMUM = 25000;
export const RECOVERY_FUND_MAXIMUM = 50000;
export const ANNUAL_MAINTENANCE_FEE = 1500;
export const MAINTENANCE_YEARS = 4;
export const TOTAL_MAINTENANCE_FUND =
  ANNUAL_MAINTENANCE_FEE * MAINTENANCE_YEARS;
