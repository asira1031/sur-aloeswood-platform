...
export default function AdminTasksPage() {
  ...
  return <AdminPage eyebrow="Tasks" title="Caretaker reports" detail="One daily card per customer and Tree ID. Open it to review QR tagging or Morning, Afternoon, and Evening evidence.">
    ...
    <section className="mt-5">
      <div className="sur-toolbar flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between"><FilterBar values={["FOR_REVIEW", "RETURNED", "HISTORY"]} selected={filter} onChange={setFilter} /><SearchBox value={search} onChange={setSearch} placeholder="Customer, caretaker, or Tree ID" /></div>
